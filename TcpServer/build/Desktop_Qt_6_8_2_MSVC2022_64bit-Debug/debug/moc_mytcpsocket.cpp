...
static constexpr auto qt_meta_stringdata_ZN11MyTcpSocketE = QtMocHelpers::stringData(
    "MyTcpSocket",
    "offline",
    "",
    "MyTcpSocket*",
    ...
    "recvMsg",
    "handleClientOffline",
    "handledownloadFileData"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
#endif // !QT_MOC_HAS_STRINGDATA

Q_CONSTINIT static const uint qt_meta_data_ZN11MyTcpSocketE[] = {
...
Q_CONSTINIT const QMetaObject MyTcpSocket::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11MyTcpSocketE.offsetsAndSizes,
    qt_meta_data_ZN11MyTcpSocketE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11MyTcpSocketE_t,
        // Q_OBJECT / Q_GADGET
        ...
        // method 'recvMsg'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'handleClientOffline'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'handledownloadFileData'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void MyTcpSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->handledownloadFileData(); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (MyTcpSocket::*)(MyTcpSocket * );
            if (_q_method_type _q_method = &MyTcpSocket::offline; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *MyTcpSocket::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11MyTcpSocketE.stringdata0))
